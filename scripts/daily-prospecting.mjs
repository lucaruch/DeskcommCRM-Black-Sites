...
Regra de oferta de site: se site estiver vazio e o negocio depender de vitrine, captacao ou pedidos digitais (por exemplo loja de roupas, loja de moveis, restaurante, clinica, escola ou prestador de servicos), trate a criacao de um site profissional como oferta conveniente e mencione-a com naturalidade em automacao_proposta e mensagem_inicial. Para outros nichos, ofereca site somente quando a pesquisa indicar beneficio claro. Se site estiver preenchido, NAO ofereca criacao ou refacao de site e nao diga que a empresa nao tem site; foque somente na oportunidade de automacao observada. Nao ofereca site de forma generica: use a oferta apenas quando a ausencia de site foi verificada e for comercialmente conveniente.
